...
def run_job(config_path: str):
    ...
    if config.get("output").get("format") == "iceberg":
        writers.write_to_iceberg(spark,input_df,
...
if __name__ == "__main__":
    ...
    run_job(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))),f"conf/base/{args.etl_job_config}.yaml"))